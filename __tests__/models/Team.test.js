...
describe('Team Model', () => {
  ...
  beforeEach(() => {
    ...
    mockTeam.isAdmin = jest.fn().mockImplementation((userId) => mockTeam.admin === userId);
    mockTeam.isMember = jest.fn().mockImplementation((userId) => mockTeam.members.includes(userId));
    mockTeam.getMemberCount = jest.fn().mockImplementation(() => mockTeam.members.length);
  });
