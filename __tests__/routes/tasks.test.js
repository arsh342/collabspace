...
describe('Tasks Routes', () => {
  ...
  beforeEach(() => {
    ...
    // Mock routes
    mockRouter.get('/teams/:teamId/tasks', mockAuthenticateSession, mockRequireTeamMembership, (req, res) => {
      res.json({
        success: true,
        tasks: [
    ...
    mockRouter.post('/teams/:teamId/tasks', mockAuthenticateSession, mockRequireTeamMembership, (req, res) => {
      if (!req.body.title) {
    ...
    mockRouter.get('/teams/:teamId/tasks/:taskId', mockAuthenticateSession, mockRequireTeamMembership, (req, res) => {
    ...
    mockRouter.put('/teams/:teamId/tasks/:taskId', mockAuthenticateSession, mockRequireTeamMembership, (req, res) => {
      res.json({ success: true, message: 'Task updated successfully' });
    });

    mockRouter.delete('/teams/:teamId/tasks/:taskId', mockAuthenticateSession, mockRequireTeamMembership, (req, res) => {
      res.json({ success: true, message: 'Task deleted successfully' });
    });

    mockRouter.patch('/teams/:teamId/tasks/:taskId/status', mockAuthenticateSession, mockRequireTeamMembership, (req, res) => {
